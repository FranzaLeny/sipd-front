...
export const BlSubGiatUncheckedCreateInputSchema = z
   .object({
      ...
      nama_pptk: z
         ...
         .nullable()
         .transform((v) => (v === '' ? null : v)),
      nama_program: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
      nama_skpd: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
      nama_sub_giat: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
      nama_sub_skpd: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
      nama_unit: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
      nama_urusan: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
      nama_urusan_pusat: z
         .string()
         .optional()
         .nullable()
...
export const BlSubGiatAktifSchema = z.object({
   ...
   kunci_bl: z.number().int(),
   kunci_bl_rinci: z.number().int(),
   nama_bidang_urusan: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
   nama_giat: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
   nama_program: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
   nama_skpd: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
   nama_sub_giat: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
   nama_sub_skpd: z.string()?.transform((v) => v.replace(/\n/g, ' ').replace(/\s\s+/g, ' ')),
